  ...
  return (
    <div className="min-h-screen bg-[#F4EADE] flex flex-col items-center justify-center p-4 text-[#2B2B2B]">
      <div className="w-full max-w-xl bg-[#EFE3D3] rounded-3xl p-6 sm:p-8 border border-[#8A7968]/30 shadow-xl space-y-6">
        <div className="flex flex-col items-center text-center space-y-2.5 border-b border-[#8A7968]/20 pb-4">
          ...
          <div>
            ...
            <p className="text-xs text-[#8A7968] mt-1">
              ...
              {authMode === 'FORGOT_PASSWORD' && 'Enter your registered official email to receive a password reset link.'}
            </p>
          </div>
        </div>
        ...
        {successMsg && (
          <div className="p-4 bg-green-100 border border-green-300 text-green-800 text-xs rounded-xl font-bold leading-relaxed">
            ✓ {successMsg}
          </div>
        )}
        ...
        {authMode === 'FORGOT_PASSWORD' && (
          <form onSubmit={handleForgotPassword} className="space-y-4">
            ...
            <button
              ...
              className="w-full text-center text-xs font-bold text-[#8A7968] hover:underline block pt-2 cursor-pointer"
            >
              ← Back to Sign In
            </button>
          </form>
